        ...
        <Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box sx={{ maxWidth: '1000px', margin: 'auto' }}>
              ...
              <Typography paragraph>
                TVEV Ratio = (TokenPriceInBTC * TotalTokenSupply) / (24hrExchangeVolumeInBTC)
              </Typography>
              <Typography paragraph>
              ...
              <Typography paragraph>
                As an example, let us calculate the TVEV ratio of an exchange coin on a particular day which the:
              </Typography>
              <Typography paragraph>
              ...
              <Typography paragraph>
                A low TVEV ratio relative to its typical normal range of the token, may mean that crypto investors and traders are expecting limited growth prospects and having low expectations on its transactional activity, or it can mean that they might have overlooked this token resulting in the token being undervalued.
              </Typography>
              <Typography paragraph>
