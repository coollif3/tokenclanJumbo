...
import { Box, List, ListItem, ListItemText, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Button, CardMedia, Container, Grid, Typography } from '@mui/material';
          ...
          {/* <Grid item xs={12} md={6}> */}
            ...
            <Box sx={{ maxWidth: '1000px', margin: 'auto' }}>
              ...
              <Box mb={3}>
                ...
                <Typography variant="body1" gutterBottom>
                  If you have any concerns or would like further information about our use of data or this notice in general, you can contact our Data Protection Officer through email; support@tokenclan.io
                </Typography>
              </Box>
              <Box mb={3}>
                <Typography variant="h4" mb={2} gutterBottom>
            ...
            <TableContainer component={Paper}>
              <Table>
                <TableHead>
                  <TableRow>
                    <TableCell sx={cellStyle}>Category Of Personal Data</TableCell>
                    <TableCell sx={cellStyle}>Purpose Of Processing</TableCell>
                    <TableCell sx={cellStyle}>Lawful Basis For Processing</TableCell>
