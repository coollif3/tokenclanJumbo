                ...
                {Object.keys(coinProfile).map((key) => {
                    ...
                    return (
                        <Grid
                            item
                            xs={12}
                            sm={displayKey === `About ${coinProfile.coin_profile_name}` && value !== 'N.A' ? 12 : 6}
                            md={displayKey === `About ${coinProfile.coin_profile_name}` && value !== 'N.A' ? 12 : 4}
                            key={key}
                        >
                                ...
                                <CardContent>
                                    ...
                                    {key === 'description' && value !== 'N.A' ? (
                                        ...
                                        <Typography variant="body1">
                                            {['homepage', 'subreddit_url'].includes(key) && value !== 'N.A' ? (
