...
export const getExchangeTvevChngBySlug =
  "SELECT t.ratio, t.1day_ratio_chng, t.7day_ratio_chng, t.30day_ratio_chng FROM coin_tvev_chng AS t INNER JOIN coins AS c ON c.id = t.coin_id WHERE c.name_id = :slug ORDER BY t.created_on DESC LIMIT 1";
